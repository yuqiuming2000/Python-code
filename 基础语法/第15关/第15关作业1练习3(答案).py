...
file1 = open(r'C:\Users\喻秋明\Desktop\test\winner.txt','r',encoding='utf-8') 
...
print(final_scores)
new_winner=open(r'C:\Users\喻秋明\Desktop\test\new_winner2.txt','a',encoding='utf-8') 
new_winner.writelines(final_scores)
new_winner.close()