...
name=bs.find_all('p',class_='name')
feedstock=bs.find_all('p',class_='ing ellipsis')
list_all=[]
for i in range(len(name)):
    URL = 'http://www.xiachufang.com'+name[i].find('a')['href']
    food=[name[i].text,URL,feedstock[i].text]
